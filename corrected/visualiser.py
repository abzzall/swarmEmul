...
import constants
from env_corrected import Agent
from env_corrected import Drawable
from env_corrected import Env
from env_corrected import Wall
...
def env_surface(env: Env, scale_koef=1.0, min_agent_size=0, draw_way=False) -> Surface:
    ...
    for agent in env.agents:
        draw_agent(agent, display, scale_koef, color=RED if agent.is_dead else TURQUOISE, min_size=min_agent_size)
