...
from corrected.constants import *
...
from env_corrected import Env
from corrected.visualiser import episode_gui
...
if __name__ == '__main__':
    ...
    #############################################
    # env = Env(250, 250, 210, 160, N * N, Dx, Dy, sensor_range, 20, 20, ROBOT_RADIUS, 4, 50000)
    ...
    env = Env(250, 250, 125, 210, N * N, Dx, Dy, sensor_range, 125, 40, ROBOT_RADIUS, 4, 50000)
    # env.addObstacle(100, 70, 150, 100)
    #
    # env.addObstacle(50, 130, 100, 170)
    # env.addObstacle(150, 130, 200, 170)
    env.addObstacle(80, 100, 180, 150)
    ...
    episode_gui(env, w1, w2, w3, draw_way=True, window_width=1000, window_height=1000, fps=150)
