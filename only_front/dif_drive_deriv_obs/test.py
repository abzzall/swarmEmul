...
from only_front.dif_drive_deriv_obs.env_front_lidar_dif_drive import Env
from only_front.dif_drive_deriv_obs.visualiser import episode_gui
...
if __name__ == '__main__':
    ...
    episode_gui(env, 0.2, 3, draw_way=True, window_width=1000, window_height=1000, fps=150)
