...
from only_front.differential_driven.env_front_lidar_dif_drive import *
...
def episode_gui(env: Env, dv, vmax,  window_width=WINDOW_SIZE, window_height=WINDOW_SIZE, min_agent_size=0, fps=FPS,
                draw_way=False):
    pygame.init()
