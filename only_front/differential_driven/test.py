...
from only_front.differential_driven.env_front_lidar_dif_drive import Env
from only_front.differential_driven.visualiser import episode_gui
...
if __name__ == '__main__':
    ...
    env = Env(500, 500, 250, 480, N * N, Dx, Dy, sensor_range, 250, 20, ROBOT_RADIUS, SENSOR_DETECTION_COUNT, 50000)
    env.addObstacle(200, 150, 300, 250)
    #
    env.addObstacle(50, 250, 150, 350)
    env.addObstacle(350, 250, 450, 350)
    ############################################



    episode_gui(env, 0.5, 3, draw_way=True, window_width=1000, window_height=1000, fps=150)
